...
class Category extends Component {
	...
	getData(table) {
		fetch("https://api.sammurphey.net/v2/index.php?table=" + table + "&public=true&sort_by=order")
			.then(res => res.json())
				.then((data) => {
...
class CategoryPreview extends Component {
	...
	getData (category) {
		var _url = "https://api.sammurphey.net/v2/index.php?table=categories&public=true";
		if (category === "all") {
