	...
	<section id="social_panel" className="panel">
		...
		<div className="chips_container">
			<a href="https://patreon.com/sammurphey" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/patreon.svg" alt="Patreon Logo" title="Patreon" />
			</a>
			<a href="https://twitter.com/weirdoonthebus" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/twitter.svg" alt="Twitter Logo" title="Twitter" />
			</a>
			<a href="https://instagram.com/essaitchteeemel" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/instagram.svg" alt="Instagram Logo" title="Instagram" />
			</a>
			<a href="https://sammurphey.tumblr.com" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/tumblr.svg" alt="Tumblr Logo" title="Tumblr" />
			</a>
			<a href="https://ello.co/sammurphey" className="btn chip" rel="noopener noreferrer">
				<img className="icon" src="https://cdn.sammurphey.net/social/ello.svg" alt="Ello Logo" title="Ello" />
			</a>
			<a href="https://sammurphey.bandcamp.com" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/bandcamp.svg" alt="Bandcamp Logo" title="Bandcamp" />
			</a>
			<a href="https://soundcloud.com/sammurphey" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/soundcloud.svg" alt="Soundcloud Logo" title="Soundcloud" />
			</a>
			<a href="https://github.com/sammurphey" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/github.svg" alt="GitHub Logo" title="GitHub" />
			</a>
			<a href="https://codepen.com/sammurphey" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/codepen.svg" alt="CodePen Logo" title="CodePen" />
			</a>
			<a href="https://stackoverflow.com/users/2719504/sam-murphey" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/stackoverflow.svg" alt="StackOverflow Logo" title="StackOverflow" />
			</a>
			<a href="https://facebook.com" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/facebook.svg" alt="Facebook Logo" title="Facebook" />
			</a>
			<a href="https://www.linkedin.com/in/sammurphey" className="btn chip" rel="noopener noreferrer" target="_blank">
				<img className="icon" src="https://cdn.sammurphey.net/social/linkedin.svg" alt="LinkedIn Logo" title="LinkedIn" />
			</a>
		</div>
