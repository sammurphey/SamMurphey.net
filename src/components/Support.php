<section id="support" class="panel">
	...
	<nav>
		<ul>
	<?php
		echo "<li><a href='https://patreon.com/sammurphey' rel='noopener noreferrer' class='btn cta_btn' target='_blank'>";
		$btn_img = file_get_contents($cdn_root . "ui/social/patreon.svg");
		echo $btn_img;
		echo "Patreon</a></li>";
		echo "<li><a href='https://www.paypal.me/sammurphey' rel='noopener noreferrer' class='btn cta_btn' target='_blank'>";
		$btn_img = file_get_contents($cdn_root . "ui/social/paypal.svg");
		echo $btn_img;
		echo "PayPal</a></li>";
		echo "<li><a href='http://ko-fi.com/sammurphey' rel='noopener noreferrer' class='btn cta_btn' target='_blank'>";
