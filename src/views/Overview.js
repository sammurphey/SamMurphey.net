...
class OverviewView extends Component {
	...
	getData () {
		...
		if (this.props.category !== "all") {
			...
			this.setState({"gridUrl": "https://api.sammurphey.net/v2/index.php?view=overview&public=true&sort_by=date&sort_dir=DESC"});
		}
	}
	updateGrid (data) {
		var url = "https://api.sammurphey.net/v2/index.php?category=" + data.category  + "&view=overview&public=true&sort_by=date&sort_dir=DESC";
		console.log(url);
